...
class Fresque : public ObjectInterface
{
    ...
    public:
        ...
        /**
         * @brief remove a objectinterface
         * @return a boolean
         */
        bool remove();
        /**
         * @brief getArea return la somme des aires des sous elements
         * @return
         */
        float getArea();
        /**
         * @brief getPerimeter retourne la somme des permitres des sous elements
         * @return
         */
        float getPerimeter();
